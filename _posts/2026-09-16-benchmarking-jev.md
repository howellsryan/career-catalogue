...
description: "I benchmarked TypeSafe AI's Jev model inside PocketRPG to see whether a specialist decision model could route natural-language requests more accurately and efficiently."
tags: [ai, projects]
---
...
At the time of the benchmark, the helper had **62 tool schemas**. Fourteen were always available to the main model and 48 were hidden behind progressive discovery.
...
Previously, that discovery used lexical matching.
...
In PocketRPG, Jev now has one narrow responsibility:
...
That is not the same as proving a 79% end-to-end saving.
...
What I can say from this benchmark is:
...
- It reduced Top 6 routing misses from **15.1% to 0%** on my benchmark, which can reduce the need for additional model/tool-search rounds.
